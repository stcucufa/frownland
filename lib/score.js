...
// Set a value for a property or attribute with a given name on a target.
export const Set = assign((target, name) => create().call(Set, { target, name }), {
    tag: "Set",
    hasEffect: true,
    dur,
    ...
    instantiate(instance, t, dur) {
        ...
        if (end > t) {
            ...
            const set = extend(instance, { t, forward: () => {
                instance.value = instance.parent?.item.inputForChildInstance(instance);
            ...
            return [
                ...
                extend(instance, { t, forward: (t, interval) => {
                    ...
                    this.instanceDidBegin.call(
                        ...
                        if (!instance.error) {
                            // The instance may have ended already because it timed out or was cancelled,
                            // so ignore the error.
...
const Repeat = assign(child => extend(Repeat, { child }), {
    ...
    instantiate(instance, t, dur) {
        ...
        if (instance.maxEnd === t) {
            ...
            instance.begin = t;
            instance.end = Duration.has(this) ? instance.maxEnd : Infinity;
        }
...
function take(n = Infinity) {
    ...
    Capacity.set(this, isNumber(n) && n >= 0 ? n : 0);
    return this;
}

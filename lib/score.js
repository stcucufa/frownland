...
export const Element = assign((element, parent, sibling) => create().call(
    Element, { element, parent, sibling }
), {
    tag: "Element",
    hasEffect: true,
    dur,
    ...
    instantiate(instance, t, dur) {
        ...
        if (end > t) {
            ...
            return [
                extend(instance, { t, forward: () => {
                    return (this.parent ?? document.body).insertBefore(this.element, this.context);
                } }),
                extend(instance, { t: end, forward: () => {

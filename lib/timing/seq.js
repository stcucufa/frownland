...
import {
    ...
    Container, Item, _Item, CancelError, FailureError, InputError
} from "./util.js";
...
// of the last child.
export const Seq = Container(extend(_Item, {
    tag: "Seq",
    take,
    dur,
    ...
    map(x) {
        ...
        return typeof x === "function" ? Item(["g"], _FunctionMap)(x) : Item(["child"], _Map)(x);
    },
...
const _FunctionMap = extend(_Fold, {
    tag: "Seq/map",

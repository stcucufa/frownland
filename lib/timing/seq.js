import { create, extend, isNumber, push } from "../util.js";
import { Instant } from "./instant.js";
import {
    dur, ended, endOf, failed, forward, hasModifier, min, pruned, show, take,
    Container, Item, CancelError, FailureError, InputError
} from "./util.js";
...
export const Seq = Container({
    ...
    map(x) {
        ...
        return typeof x === "function" ? Item(["g"], FunctionMap)(x) : Item(["child"], Map)(x);
    },

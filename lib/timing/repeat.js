...
export const Repeat = assign(child => extend(Repeat, { child }), {
    ...
    // Wrap the repeat in a Par.take(1) with x as the other child; the
    // repetition then ends when x finishes.
    until(x) {
        return Par(this, x).take(1);
    },

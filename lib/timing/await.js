...
import {
    cancelled, dur, ended, failed, hasModifier, item, inputParameters, label, min, pruned, show,
    varModifier, CancelError, TimeoutError
} from "./util.js";

// Schedule an async function and await its return.
export const Await = item(f => ({ instanceDidBegin: f }), {
    tag: "Await",
    show,
    label,
    dur,

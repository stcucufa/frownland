...
import {
    cancelled, dur, ended, failed, hasModifier, inputParameters, label, min, pruned, show, varModifier,
    Item, CancelError, TimeoutError
} from "./util.js";

// Schedule an async function and await its return.
export const Await = Item(["instanceDidBegin"], {
    tag: "Await",
    show,
    label,
    dur,

import { assign, create, extend, isNumber, partition, push, remove } from "../util.js";
import { repeat } from "./repeat.js";
import {
    dur, ended, endOf, failed, forward, hasModifier, init, max, min, pruned, show, take,
...
export const Par = assign((...children) => create().call(Par, { children }), {
    ...
    valueForInstance() {
        const value = (hasModifier(this, "take") ? this.finished : this.children).map(child => child.value);

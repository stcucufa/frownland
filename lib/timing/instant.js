import { assign, I, isNumber, nop, parseTime, safe } from "../util.js";
import { Delay } from "./delay.js";
import { Seq } from "./seq.js";
import { cancelled, forward, pruned, varModifier, Item } from "./util.js";
...
export const Effect = Item(["valueForInstance"], assign({}, Instant, {
    tag: "Effect",
    hasEffect: true,
}));
